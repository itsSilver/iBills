...
import CategoryCreateChildren from '~/components/Modals/Categories/CategoryCreateChildren.vue'
...
export default {
  ...
  methods: {
    ...
    async loadAsyncData() {
      ...
      this.loading = true
      await this.$axios
        .get(`/categories/children/${this.parent}`, {
          headers: {
